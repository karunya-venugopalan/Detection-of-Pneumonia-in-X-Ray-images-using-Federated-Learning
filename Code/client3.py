...
# Loading the data
train = pd.read_csv('C://Users//Karunya V//Documents//sem5//ML lab//Package//chest_xray//data//client3_train.csv')
test = pd.read_csv('C://Users//Karunya V//Documents//sem5//ML lab//Package//chest_xray//data//client3_test.csv')
x = train.iloc[:,3:2502]
y = train['Diagnosis']
...
def ModelKNN():
    ...
    print("Best K recieved at client3: ",kFinal)
...
def ModelSVM():
    d = client.recv(1048576)
    wFinal = pickle.loads(d)
    print("SVM parameters recieved at client3")
    w = wFinal[0:-1]
    b = wFinal[-1]
    ypred = []
    for i in xtest.values:
...
sendString("Hello World! from Client 3")
