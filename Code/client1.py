...
def ModelLogReg():
    ...
    print("Logistic regression parameters recieved client1 ")
    ypred = []
    w = wFinal[0:-1]
    b = wFinal[-1]
...
def ModelKNN():
    ...
    print("Best K recieved at client1: ",kFinal)
...
def ModelSVM():
    d = client.recv(1048576)
    wFinal = pickle.loads(d)
    print("SVM parameters recieved at client1")
    w = wFinal[0:-1]
    b = wFinal[-1]
    ypred = []
    for i in xtest.values:
...
sendString("Hello World! from Client 1")
